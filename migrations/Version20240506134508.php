 ...
 */
final class Version20240506134508 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Adds worktime period table';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE worktime_period (id INT NOT NULL, employee_id INT DEFAULT NULL, start_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, end_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
