 ...
 */
final class Version20240507103726 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME_EMPLOYEE ON employee (username)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_IDENTIFIER_USERNAME_EMPLOYEE');
